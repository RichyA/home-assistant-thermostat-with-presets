"""Switch platform for thermostat_with_presets."""
...
class ThermostatWithPresetsSwitch(ThermostatWithPresetsEntity, SwitchEntity):
    """thermostat_with_presets switch class."""
